...
<body onload="initMap()">
<h3>Benvenuto nella Weather App!</h3><br>
       <form action="getData" method="post">
            Inserisci il codice zip della tua area: <input type="text" name="zip">
       ...
       <div class="map">
    	   ...
    	   <h3>Dati meteo per ${name }, ${region }</h3><br>
 ...
 <table id="forecast" style="width:90%">
    ...
    <tbody>
            	<tr>
            		<td colspan="2"><h2>Previsioni a 7 giorni</h2></td>
            	</tr>
            	<tr>
            		<td>${d0 }</td>
            		<td><img src ="${i0 }"></td>
